  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarColor02">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="testimonial.php">Testimonial</a>        
        </li>
        <li class="nav-item">
...
<center>
<font color="green" style="font-family: Arial;"><h1><b> Testimonials</b></h1> </font>
</center>
<br>
<br>
                  ...
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="post">
                      <div class="user-block">
                        <img class="img-circle img-bordered-sm" src="../man-avatar-profile-vector-21372076.jpg" alt="user image">
                        <span class="username">
                          Manny Pacquiao.
